 ...
 */
#ifndef LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_MAPPING_HPP_
#define LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_MAPPING_HPP_
...
#endif // LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_MAPPING_HPP_