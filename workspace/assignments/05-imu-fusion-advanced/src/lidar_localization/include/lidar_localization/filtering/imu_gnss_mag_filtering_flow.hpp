 ...
 */
#ifndef LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_FLOW_HPP_
#define LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_FLOW_HPP_
...
class IMUGNSSMagFilteringFlow {
  public:
    IMUGNSSMagFilteringFlow(ros::NodeHandle& nh);
    bool Run();
  ...
  private:
    ...
    // filtering instance:
    std::shared_ptr<IMUGNSSMagFiltering> filtering_ptr_;
...
#endif // LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_FLOW_HPP_