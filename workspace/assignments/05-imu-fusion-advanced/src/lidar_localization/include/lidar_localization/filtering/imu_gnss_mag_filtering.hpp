/*
 * @Description: IMU-GNSS-Mag fusion for localization
 * @Author: Ge Yao
 * @Date: 2020-11-12 15:14:07
 */
#ifndef LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_HPP_
#define LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_HPP_
...
class IMUGNSSMagFiltering {
  public:
    ...
    void GetStandardDeviation(EKFStd &eskf_std_msg);
...
#endif // LIDAR_LOCALIZATION_FILTERING_IMU_GNSS_MAG_FILTERING_HPP_